...
class WorkSession(db.Model):
    ...
    started_at: Mapped[TIMESTAMP] = mapped_column(TIMESTAMP(), nullable=False)
    ended_at: Mapped[TIMESTAMP] = mapped_column(TIMESTAMP(), nullable=False)
    ...
    atypical_session: Mapped[bool] = mapped_column(bool(), nullable=False)
    extended_retention: Mapped[bool] = mapped_column(bool(), nullable=False)
    retention_until: Mapped[TIMESTAMP] = mapped_column(TIMESTAMP(), nullable=False)
